   ...
   1. Definitions.
      ...
      modifications, that is intentionally submitted to Licensor for
   ...
   4. Redistribution.
      ...
      (d) If the Work includes a "NOTICE" text file, You must include it.
   ...
   7. Disclaimer of Warranty.
      ...
      Work on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY
      KIND.
   ...
   9. Accepting Warranty or Additional Liability.
      ...
      warranty, but You may do so only on Your own behalf.

   END OF TERMS AND CONDITIONS

   Copyright 2025 Future_Ready
